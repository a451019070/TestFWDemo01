...
Pod::Spec.new do |spec|
  ...
  spec.name         = "OBDataService"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of OBDataService."
  ...
  spec.homepage     = "http://EXAMPLE/OBDataService"
  ...
  spec.source       = { :git => "http://EXAMPLE/OBDataService.git", :tag => "#{spec.version}" }
